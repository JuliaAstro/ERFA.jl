...
5. The algorithm draws on several sources, as follows:
   ...
   - The formula for the saturation vapour pressure of water as
   ...
   - The refractivity of air is a function of temperature,
   ...
   - The formula for beta, the ratio of the scale height of the
   ...
   - The formulae for the refraction constants as a function of
